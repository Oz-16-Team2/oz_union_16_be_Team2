...
from apps.users.serializers.auth_serializers import LoginSerializer, TokenRefreshSerializer
...
class TokenRefreshAPIView(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        serializer = self.serializer_class(data={"refresh_token": refresh_token_value})
        serializer.is_valid(raise_exception=True)

        result = refresh_token(refresh_token=serializer.validated_data["refresh_token"])
