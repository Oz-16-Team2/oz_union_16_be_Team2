...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    social_profile_image_url = models.TextField(null=True, blank=True)
...
class SocialLogin(models.Model):
    ...
    social_nickname = models.CharField(max_length=100, null=True, blank=True)
    social_profile_image_url = models.URLField(max_length=2048, null=True, blank=True)
